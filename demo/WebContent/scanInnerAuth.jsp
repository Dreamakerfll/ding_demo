...
<body >
	...
	<div id="login_container" class="scan_area"></div>
	<script type="text/javascript">

	var appid = "<%= com.alibaba.dingtalk.openapi.demo.Env.APP_ID %>";
	...
	//在此拿到权限验证配置所需要的信息
	var _config = <%= com.alibaba.dingtalk.openapi.demo.auth.AuthHelper.getConfigInnerScan(request,response) %>;
